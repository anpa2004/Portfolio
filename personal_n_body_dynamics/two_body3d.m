...
state0 = [x10;y10;x20;y20;v1x0;v1y0;v2x0;v2y0;z10;z20;v1z0;v2z0]; 
tspan = [0;500];
...
for i = 1:size(t)
    scatter3(state(i,1),state(i,2),state(i,9),'blue');
    scatter3(state(i,3),state(i,4),state(i,10),'red');
    pause(0.001)
end
...
function [vec] = EOMfunc(~,state,const)
    ...
    a1z = (1/const.m1)*Fg*(z2-z1)/r;
    a2z = -a1z;    

    vec = [v1x;v1y;v2x;v2y;a1x;a1y;a2x;a2y;v1z;v2z;a1z;a2z];

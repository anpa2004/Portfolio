...
title("Model II: Aluminum - 26V,250mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model II: Aluminum - 28V,269mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model II: Brass - 26V,245mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model II: Brass - 29V,273mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model II: Steel - 21V,192mA")

...
title("Model IA: Aluminum - 26V,250mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model IA: Aluminum - 28V,269mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model IA: Brass - 26V,245mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model IA: Brass - 29V,273mA")
...
ylabel('Temperature (^\circC)')
legend('Experimental','Model','','','','','','','','','','','','','','','Location','northwest')
title("Model IA: Steel - 21V,192mA")
